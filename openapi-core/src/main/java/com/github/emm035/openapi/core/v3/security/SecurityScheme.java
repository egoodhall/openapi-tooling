...
public interface SecurityScheme
  extends
    Extensible, Describable, Typed<SecurityScheme.Type>, Referenceable<SecurityScheme> {
  enum Type {
    API_KEY,
    HTTP,
    OAUTH2,
    ...
    private static final Converter<String, String> TO_JSON_CASE_CONVERTER = CaseFormat.UPPER_UNDERSCORE.converterTo(
      CaseFormat.LOWER_CAMEL
    );
    private static final Converter<String, String> FROM_JSON_CASE_CONVERTER = CaseFormat.UPPER_UNDERSCORE.converterTo(
      CaseFormat.LOWER_CAMEL
    );
